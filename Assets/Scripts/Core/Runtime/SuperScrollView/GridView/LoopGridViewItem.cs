...
namespace Core.Runtime.SuperScrollView.GridView
{
    public class LoopGridViewItem : MonoBehaviour
    {
        ...
        public LoopGridView ParentGridView { get { return mParentGridView; } set { mParentGridView = value; } }

        public LoopGridViewItem PrevItem { get { return mPrevItem; } set { mPrevItem = value; } }
        public LoopGridViewItem NextItem { get { return mNextItem; } set { mNextItem = value; } }
    }
}
namespace HotUpdate.SuperScrollView.Scripts.GridView
{
    ...
    public class GridItemGroup
    {
        ...
        public LoopGridViewItem First { get { return mFirst; } }

        public LoopGridViewItem Last { get { return mLast; } }

        public int GroupIndex { get { return mGroupIndex; } set { mGroupIndex = value; } }
